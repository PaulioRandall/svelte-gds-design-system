...
<DocsPage
	...
	title="Warning text"
	gds_name="Warning text"
	gds_link="https://design-system.service.gov.uk/components/warning-text/"
	crumbs="{[
		['/home', 'Home'],
		['/general-components', 'General components'],
		['/general-components/warning-text', 'Warning text'],
	]}"
	...
	<svelte:fragment slot="slots">
		<DocsSlot default_slot summary="Text content" />
	</svelte:fragment>
</DocsPage>
